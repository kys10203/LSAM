...
{
  struct cblk471 * c_blk = (struct cblk471 *)arg;
...
*/
    ...
    else
    {
      if(APInitialize(c_block471.nHandle) == S_OK)/* Initialize */
      {
        ...
        pthread_create(&IHandler, NULL, InterruptHandlerThread, &c_block471);
      }
    }
...
void scfg471(struct cblk471 *c_blk)
...
void psts471(struct cblk471 *c_blk)
//struct cblk471 *c_blk;
{
